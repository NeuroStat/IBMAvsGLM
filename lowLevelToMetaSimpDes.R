####################
#### TITLE:     Simulate null data from low subject level to meta-analysis. Simple design, 10 voxels.
#### Contents:
####
...
save(SCOPE, file=paste(wd,'/Results/',K,'/SCEN_',SCEN,'/SD_SCOPE_',K,sep=''))
save(SVARCOPE, file=paste(wd,'/Results/',K,'/SCEN_',SCEN,'/SD_SVARCOPE_',K,sep=''))
save(STMAP, file=paste(wd,'/Results/',K,'/SCEN_',SCEN,'/SD_STMAP_',K,sep=''))
save(SHEDGE, file=paste(wd,'/Results/',K,'/SCEN_',SCEN,'/SD_SHEDGE_',K,sep=''))
save(WeightedAvg, file=paste(wd,'/Results/',K,'/SCEN_',SCEN,'/SD_WeightedAvg_',K,sep=''))
save(varWeightAvg, file=paste(wd,'/Results/',K,'/SCEN_',SCEN,'/SD_varWeightAvg_',K,sep=''))
save(CI.upper.norm, file=paste(wd,'/Results/',K,'/SCEN_',SCEN,'/SD_CI.upper.norm_',K,sep=''))
save(CI.lower.norm, file=paste(wd,'/Results/',K,'/SCEN_',SCEN,'/SD_CI.lower.norm_',K,sep=''))
save(CI.upper.t, file=paste(wd,'/Results/',K,'/SCEN_',SCEN,'/SD_CI.upper.t_',K,sep=''))
save(CI.lower.t, file=paste(wd,'/Results/',K,'/SCEN_',SCEN,'/SD_CI.lower.t_',K,sep=''))
save(CI.upper.weightVar, file=paste(wd,'/Results/',K,'/SCEN_',SCEN,'/SD_CI.upper.weightVar_',K,sep=''))
save(CI.lower.weightVar, file=paste(wd,'/Results/',K,'/SCEN_',SCEN,'/SD_CI.lower.weightVar_',K,sep=''))
