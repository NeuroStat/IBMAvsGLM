...
* Simulation of activation: might want to create one file where parameters are defined. Instead of having the same code copied into simulation, analysis and plotting.
