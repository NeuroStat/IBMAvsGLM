####################
#### TITLE:     Simulate null data for linear regression to meta-analysis.
#### Contents:
####
...
# Here, we try to check coverages of a simple linear regression fit to a meta-analysis.
	# Let us say: predictor is weight of subjects
	# Y variable is IQ.
